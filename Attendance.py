...
# first header image  
    ...
    #Update button
        #del_btn=Button(main_frame,command=self.update_data,text="Export CSV",width=12,font=("verdana",12,"bold"),fg="white",bg="#002B53")
        #del_btn.place(x=650,y=740,height=30,width=100)
    #Update button
        del_btn=Button(main_frame,command=self.delete_data,text="Delete",width=12,font=("verdana",12,"bold"),fg="white",bg="#002B53")
        del_btn.place(x=670,y=740,height=30,width=100)
